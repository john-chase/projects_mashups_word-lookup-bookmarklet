        ...
        if (json[0]) {
            ...
            if(json[0].phonetics.length) {
                ...
                phonetics.forEach(item => {
                    if(item.audio !== undefined && item.audio.length) return audio = `<a href="${item.audio}" target="_blank"><span class="def-audio" alt="Click/tap for audio"></span></a>`;
