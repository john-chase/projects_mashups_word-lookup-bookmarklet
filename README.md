...
## Alternate Version - Definition in widget bar
Uses the right side of the "Definitions" bar to display the lookup result instead of a tooltip - adds audio phonetics (pronunciation) link.

--- 

More Instructions: Get the JavaScript code [here](https://github.com/john-chase/projects_mashups_word-lookup-bookmarklet/blob/barDisplay/dist/js/main.js) to paste into the URL input of your bookmarklet.
