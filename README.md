...
More Instructions: Get the JavaScript code [here](https://github.com/john-chase/projects_mashups_word-lookup-bookmarklet/blob/defInBar/dist/js/main.js) to paste into the URL input of your bookmarklet.
